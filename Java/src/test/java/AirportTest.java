...
public class AirportTest {
    private static List<Plane> planes = Arrays.asList(
            ...
            new ExperimentalPlane("Ryan X-13 Vertijet", 560, 307, 500,
                    ExperimentalTypes.VERTICAL_TAKEOFF, ClassificationLevel.TOP_SECRET)
    );
    ...
    public void testGetPassengerPlaneWithMaxCapacity() {
        Airport airport = new Airport(planes);
        int actualPlaneWithMaxPassengersCapacity = airport.getPassengerPlaneWithMaxPassengersCapacity()
                .getPassengersCapacity();
        int expectedPassengersCapacity = planeWithMaxPassengerCapacity.getPassengersCapacity();
        Assert.assertEquals(actualPlaneWithMaxPassengersCapacity, expectedPassengersCapacity);
    }
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        boolean atLeastOneBomber = false;
        ...
        Assert.assertTrue(atLeastOneBomber);
    }
